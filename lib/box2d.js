...
var Event       = window.Object.create(window.Event);
var Object      = window.Object.create(window.Object);
var String      = window.Object.create(window.String);
var Element     = window.Object.create(window.Element);
var HTMLElement = window.Object.create(window.HTMLElement);
var document    = window.Object.create(window.document);
...
Event.prototype       = window.Object.create(Event.prototype);
Object.prototype      = window.Object.create(Object.prototype);
String.prototype      = window.Object.create(String.prototype);
Element.prototype     = window.Object.create(Element.prototype);
HTMLElement.prototype = window.Object.create(HTMLElement.prototype);

Event.extend = String.extend = Element.extend = HTMLElement.extend
             = document.extend = Object.extend;

document.createElement = function(n){
  return Object.getPrototypeOf(this).createElement(n);
};
document.createTextNode = function(n){
  return Object.getPrototypeOf(this).createTextNode(n);
}
...
Event.extend = (function() {
  ...
  if (Prototype.Browser.IE) {
    ...
    Event.prototype = Event.prototype || Object.create(document.createEvent("HTMLEvents").__proto__);
...
/* prototype end prototype end prototype end */
...
window["Box2D"] = {
  ...
  "BodyDef":b2BodyDef,
  "Bound":b2Bound,
  "BoundValues":b2BoundValues,
  "BoxDef":b2BoxDef,
  "BroadPhase":b2BroadPhase,
  "BufferedPair":b2BufferedPair,
  "CircleContact":b2CircleContact,
  "CircleDef":b2CircleDef,
  "CircleShape":b2CircleShape,
  "Collision":b2Collision,
  "CollisionFilter":b2CollisionFilter,
  "Contact":b2Contact,
  "ContactConstraint":b2ContactConstraint,
  "ContactConstraintPoin":b2ContactConstraintPoint,
  "ContactID":b2ContactID,
  "ContactManager":b2ContactManager,
  "ContactNode":b2ContactNode,
  "ContactPoint":b2ContactPoint,
  "ContactRegister":b2ContactRegister,
  ...
  "NullContact":b2NullContact,
  "OBB":b2OBB,
  "Pair":b2Pair,
  "PairCallback":b2PairCallback,
  "PairManager":b2PairManager,
  "PolyAndCircleContact":b2PolyAndCircleContact,
  "PolyContact":b2PolyContact,
  "PolyDef":b2PolyDef,
  "PolyShape":b2PolyShape,
